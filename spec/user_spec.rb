 ...
 RSpec.describe User, type: :model do
  describe "Validations" do 
    ...
    it 'is valid with matching password and password_confirmation fields' do
      @user = User.new(name: "Joe", email: "1@1.com", password:"cool", password_confirmation:"cool")
      expect(@user).to be_valid
    end

    it 'is invalid with non-matching password and password_confirmation fields' do
      @user = User.new(name: "Joe", email: "1@1.com", password:"poulet", password_confirmation:"pollo")
      expect(@user).to_not be_valid
    end

    it 'is valid with unique emails' do 
      @user1 = User.new(name: "Joe", email: "1@1.com", password:"pollo1", password_confirmation:"pollo1")
      @user2 = User.new(name: "Joe", email: "2@1.com", password:"pollo1", password_confirmation:"pollo1")
      expect(@user1).to be_valid
      expect(@user2).to be_valid
    end

    it 'is invalid with repeated emails (case insensitive)' do 
      @user1 = User.new(name: "Joe", email: "a@1.com", password:"pollo1", password_confirmation:"pollo1")
       expect(@user1).to be_valid
       @user1.save!
       @user2 = User.new(name: "Joe", email: "A@1.com", password:"pollo1", password_confirmation:"pollo1")
    ...
    it 'must have a minimum password length of 6 when a user account is being created' do
      @user = User.new(name: "Joe", email: "1@1.com", password:"four", password_confirmation:"cool")
      expect(@user).to_not be_valid
    end
